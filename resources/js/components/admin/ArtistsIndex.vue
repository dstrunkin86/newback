                        ...
                        <div v-for="(edu, eduIndex) in editRowData.education" :key="'edu' + eduIndex">
                            <el-row>
                                <el-col style="width: 90%;">
                                    ...
                                    <el-input v-for="lang in langs" v-model="edu.place[lang.value]" :key="'edu'+ eduIndex + 'place' + lang.value"
                                        :placeholder="lang.lineEnding"></el-input>
                                    <div class="form_subtitle">Специальность</div>
                                    <el-input v-for="lang in langs" v-model="edu.specialty[lang.value]" :key="'edu'+ eduIndex + 'specialty' + lang.value"
                                        :placeholder="lang.lineEnding"></el-input>
                                    <div class="form_subtitle">Даты обучения</div>
                                    <el-date-picker v-model="edu.dates" type="daterange" range-separator=" - " :key="'edu'+ eduIndex + 'dates'"
                                        start-placeholder="С" end-placeholder="По" style="width:100%;">
                                    </el-date-picker>
                                </el-col>
                                <el-col style="width: 10%; float:right">
                                    <i @click="deleteJSONRow('education', eduIndex)" class="el-icon-delete" style="color: red"></i>
                                </el-col>
                            </el-row>
                            <el-divider></el-divider>
                        </div>
                        <i @click="newJSONRow('education', ['place', 'specialty'], ['dates'])" class="el-icon-plus" style="color: green"></i>
                    </el-form-item>
                    <el-divider></el-divider>
                    ...
                    <el-form-item label="Квалификация">
                        <div v-for="(qual, qualIndex) in editRowData.qualification" :key="'qual' + qualIndex">
                            <el-row>
                                <el-col style="width: 90%;">
                                    <div class="form_subtitle">Место обучения</div>
                                    <el-input v-for="lang in langs" v-model="qual.place[lang.value]" :key="'qual'+ qualIndex + 'place' + lang.value"
                                        :placeholder="lang.lineEnding"></el-input>
                                    <div class="form_subtitle">Специальность</div>
                                    <el-input v-for="lang in langs" v-model="qual.specialty[lang.value]" :key="'qual'+ qualIndex + 'specialty' + lang.value"
                                        :placeholder="lang.lineEnding"></el-input>
                                    <div class="form_subtitle">Даты обучения</div>
                                    <el-date-picker v-model="qual.dates" type="daterange" range-separator=" - " :key="'qual'+ qualIndex + 'dates'"
                                        start-placeholder="С" end-placeholder="По" style="width:100%;">
                                    </el-date-picker>
                                </el-col>
                                <el-col style="width: 10%; float:right">
                                    <i @click="deleteJSONRow('qualification', qualIndex)" class="el-icon-delete" style="color: red"></i>
                                </el-col>
                            </el-row>
                            <el-divider></el-divider>
                        </div>
                        <i @click="newJSONRow('qualification', ['place', 'specialty'], ['dates'])" class="el-icon-plus" style="color: green"></i>
                    </el-form-item>
                    <el-divider></el-divider>
                        ...
                        <div v-for="(ex, exIndex) in editRowData.exhibitions" :key="'ex' + exIndex">
                            <el-row>
                                <el-col style="width: 90%;">
                                    ...
                                    <el-input v-for="lang in langs" v-model="ex.place[lang.value]" :key="'ex'+ exIndex + 'place' + lang.value"
                                        :placeholder="lang.lineEnding"></el-input>
                                    <div class="form_subtitle">Название проекта</div>
                                    <el-input v-for="lang in langs" v-model="ex.title[lang.value]" :key="'ex'+ exIndex + 'title' + lang.value"
                                        :placeholder="lang.lineEnding"></el-input>
                                    <div class="form_subtitle">Даты проведения</div>
                                    <el-date-picker v-model="ex.dates" type="daterange" range-separator=" - " :key="'ex'+ exIndex + 'dates'"
                                        start-placeholder="С" end-placeholder="По" style="width:100%;">
                                    </el-date-picker>
                                </el-col>
                                <el-col style="width: 10%; float:right">
                                    <i @click="deleteJSONRow('exhibitions', exIndex)" class="el-icon-delete" style="color: red"></i>
                                </el-col>
                            </el-row>
                            <el-divider></el-divider>
                        </div>
                        <i @click="newJSONRow('exhibitions', ['place', 'title'], ['dates'])" class="el-icon-plus" style="color: green"></i>
                    </el-form-item>
                    <el-divider></el-divider>
                        ...
                        <div v-for="(pub, pubIndex) in editRowData.publications" :key="'pub' + pubIndex">
                            <el-row>
                                <el-col style="width: 90%;">
                                    ...
                                    <el-input v-for="lang in langs" v-model="pub.place[lang.value]" :key="'pub'+ pubIndex + 'place' + lang.value"
                                        :placeholder="lang.lineEnding"></el-input>
                                    <div class="form_subtitle">Название</div>
                                    <el-input v-for="lang in langs" v-model="pub.title[lang.value]" :key="'pub'+ pubIndex + 'title' + lang.value"
                                        :placeholder="lang.lineEnding"></el-input>
                                    <div class="form_subtitle">Ссылка</div>
                                    <el-input v-model="pub.link" placeholder="https://"></el-input>
                                </el-col>
                                <el-col style="width: 10%; float:right">
                                    <i @click="deleteJSONRow('publications', pubIndex)" class="el-icon-delete" style="color: red"></i>
                                </el-col>
                            </el-row>
                            <el-divider></el-divider>
                        </div>
                        <i @click="newJSONRow('publications', ['place', 'title'], ['link'])" class="el-icon-plus" style="color: green"></i>
                    </el-form-item>
                    <el-divider></el-divider>
